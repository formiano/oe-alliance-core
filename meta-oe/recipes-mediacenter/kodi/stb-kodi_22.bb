...
# OpenDroid selects the writable Kodi profile in kodi-stb-runtime:
# /media/hdd/.kodi only when /media/hdd is a real writable mount, otherwise
# /home/root/.kodi. Do not let the generic STB core patch override that choice.
SRC_URI:remove:opendroid = "file://0052-stb-force-profile-on-media-hdd.patch"
